...
ENV OPENFIRE_USER=openfire \
    ...
    GOOGLE_APPLICATION_CREDENTIALS=/usr/local/openfire/meetplus-firebase-adminsdk.json
...
COPY meetplus-firebase-adminsdk.json /usr/local/openfire/meetplus-firebase-adminsdk.json
